...
CREATE TABLE IF NOT EXISTS `juridico`.`pessoas` (
  ...
  `pessoas_nome` VARCHAR(255) NOT NULL,
  ...
  `pessoas_cep` VARCHAR(8) NOT NULL,
  `pessoas_complemento` VARCHAR(20) NULL,
  `pessoas_numero` VARCHAR(45) NULL,
  `pessoas_estadocivil` VARCHAR(45) NULL,
  `pessoas_profissao` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `juridico`.`varas` (
  ...
  `varas_nome` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `juridico`.`processos` (
  ...
  `processos_procurador` VARCHAR(255) NULL,
  `processos_desembargador` VARCHAR(255) NULL,
  `processos_assistencia` CHAR(1) NULL,
...
CREATE TABLE IF NOT EXISTS `juridico`.`tipos_andamento` (
  ...
  `tipos_andamento_desc` VARCHAR(255) NOT NULL,
...
START TRANSACTION;
USE `juridico`;
INSERT INTO `juridico`.`usuarios` (`usuarios_id`, `usuarios_nome`, `usuarios_senha`, `usuarios_grupo`, `usuarios_del`) VALUES (default, 'cpd', '8513bd8e58bede4fe3b53765fd803635', 1, 'N');
INSERT INTO `juridico`.`usuarios` (`usuarios_id`, `usuarios_nome`, `usuarios_senha`, `usuarios_grupo`, `usuarios_del`) VALUES (default, 'marcos', 'b137613a10996cdd52e7f35d92d2cd18', 1, 'N');
INSERT INTO `juridico`.`usuarios` (`usuarios_id`, `usuarios_nome`, `usuarios_senha`, `usuarios_grupo`, `usuarios_del`) VALUES (default, 'eduardo', 'b137613a10996cdd52e7f35d92d2cd18', 1, 'N');
